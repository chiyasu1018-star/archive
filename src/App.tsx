                    ...
                    <section className="max-w-[700px] mx-auto">
                      {stories.map(s => (
                        <motion.button 
                          ...
                          className={`w-full grid grid-cols-[1fr_auto] py-8 border-b transition-colors text-left ${isDarkMode ? 'border-white/10 hover:border-white/30' : 'border-black/5 hover:border-black/20'}`}
                        >
